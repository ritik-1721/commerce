  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto max-w-fit px-1 sm:px-2 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-10">
            ...
            <div className="flex items-center">
                    ...
                    <div className="py-1">
                      {sortOptions.map((option) => (
                        <Menu.Item key={option.name}>
                          {({ active }) => (
                            <div
                              className={`mx-auto px-3 py-2 mb-2 w-24 h-6 bg-gray-200 animate-pulse  ${
                                active ? "bg-gray-100" : ""
                              }`}
                            ></div>
                          )}
              ...
              >
                ...
                <div className="w-8 h-8 bg-gray-200 rounded-none animate-pulse  p-2.5 mr-2"></div>
              </button>
              <button
                type="button"
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                >
                  {subCategories.map((category) => (
                    <li key={category.name}>
                      <div className="mb-2 w-40 h-6 bg-gray-200 animate-pulse  ">
                        {" "}
                      </div>
                    </li>
                  ))}
